...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .thiep-date {
            flex-shrink: 0; text-align: center; width: 58px;
            background: var(--surface2); border-radius: 10px; padding: 10px 6px;
        }
        ...
        .thiep-popup {
            ...
            position: relative;
            box-shadow: 0 4px 6px rgba(0,0,0,.08), 0 32px 80px rgba(0,0,0,.5);
        }
        ...
        .thiep-popup-header::after {
            content: '';
            position: absolute; bottom: 0; left: 0; right: 0; height: 4px;
            background: linear-gradient(90deg, #c8a96e 0%, #f0d596 50%, #c8a96e 100%);
        }
        ...
        .thiep-popup-header .main-title {
            font-family: 'Playfair Display', serif;
            font-size: 30px; font-weight: 700; letter-spacing: 4px;
            color: #f0d596; margin-bottom: 10px;
        }
        .thiep-popup-header .sub-title {
            font-size: 13px; font-weight: 500; opacity: .9; line-height: 1.5;
            max-width: 320px; margin: 0 auto;
        }
        .thiep-popup-header .divider-line {
            margin: 14px auto 0;
            width: 60px; height: 1.5px; background: #c8a96e; opacity: .7;
        }
        ...
        .thiep-info-row {
            ...
            padding: 11px 0; border-bottom: 1px dashed #e8dcc8;
        }
        ...
        .thiep-hoan-box {
            ...
            background: #fff8e6; border: 1px solid #e6c86e;
...
<div class="modal-overlay" id="thiepModal" onclick="if(event.target===this)closeModal()">
    <div class="thiep-popup" id="thiepPopup">
        ...
        <div class="thiep-popup-body">
            <div class="thiep-info-row">
                ...
                <div>
                    <div class="thiep-info-label">Thời gian</div>
                    <div class="thiep-info-value" id="modalThoiGian"></div>
                </div>
            </div>
            <div class="thiep-info-row">
                <div class="thiep-info-icon">📍</div>
                <div>
                    <div class="thiep-info-label">Địa điểm</div>
                    <div class="thiep-info-value" id="modalDiaDiem"></div>
                </div>
            </div>
            <div class="thiep-info-row" id="modalNoiDungRow">
                <div class="thiep-info-icon">📋</div>
                <div>
                    <div class="thiep-info-label">Nội dung</div>
                    <div class="thiep-info-value" id="modalNoiDung"></div>
                </div>
            </div>
